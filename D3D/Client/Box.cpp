...
uniform_real_distribution<double> random_xz(-4000.0f, 4000.0f);
uniform_real_distribution<double> random_y(2000.0f, 4000.0f);
uniform_real_distribution<double> random_sclae(10.0f, 15.0f);
