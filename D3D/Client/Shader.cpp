...
void GraphicsShader::Init(const wstring& path, ShaderInfo info)
{
	...
	case BLEND_TYPE::BLEND_FACTOR:
		rt.BlendEnable = FALSE;  // ºí·»µå È°¼ºÈ­
		rt.SrcBlend = D3D12_BLEND_INV_BLEND_FACTOR;  // ¼Ò½º ºí·»µå ÆÑÅÍ´Â ºí·»µå ÆÑÅÍ
		rt.DestBlend = D3D12_BLEND_BLEND_FACTOR; // ´ë»ó ºí·»µå ÆÑÅÍµµ ºí·»µå ÆÑÅÍ
		rt.BlendOp = D3D12_BLEND_OP_ADD;  // ºí·»µå ¿¬»êÀº ´õÇÏ±â
		rt.LogicOpEnable = FALSE;  // ³í¸® ¿¬»ê »ç¿ë ¾È ÇÔ
		break;
	}
